...
contactZ --shuf -i ../data/testbedpe.chr10.bedpe.gz -p ../data/CTCF.chr10.bed.gz    -n CTCF_SHUF


contactZ        -i ../data/testbedpe.chr10.bedpe.gz -p ../data/CTCF.chr10.bed.gz    -n CTCF --cached
